  ...
  <div class="p-6 bg-gray-50 min-h-screen">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
      ...
      <div class="bg-white rounded-lg p-6 shadow-sm border">
        ...
        <div class="h-64 mb-4">
          <canvas ref="supportTypesPieChartRef"></canvas>
        </div>
        <!-- Legend -->
        <div class="space-y-2">
      ...
      <div class="bg-white rounded-lg p-6 shadow-sm border">
        ...
        <div
          class="space-y-2"
          v-if="statusDoughnutData.datasets[0].data.length > 0"
        >
...
// const supportTypesPieChartRef = ref(null);
...
const {
  ...
  thematicLineChartRef,
  statusDoughnutRef,
  thematicLineChartData,
  statusDoughnutData,
  supportTypesPieChartRef,
  supportTypesPieData,
} = storeToRefs(store);
...
const initializeCharts = () => {
  // Support Types Pie Chart
  // if (supportTypesPieChartRef.value) {
  //   new Chart.Chart(supportTypesPieChartRef.value, {
  //     type: "pie",
  //     data: {
...
onMounted(() => {
  // initializeCharts();
  store.createCampaignFocusChart();
});
</script>
